...
<body>
    ...
    <div class="main-content">
            ...
            <div class="action-bar">
                ...
                <form method="GET" action="/user" style="display:contents;">
                    <div class="search-box">
                        ...
                        <input type="text" name="search" placeholder="Cari user..." value="<?php echo e($search ?? ''); ?>"
        ...
        <div class="table-card">
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="btn-action btn-edit"
                                    onclick="bukaModalEdit(<?php echo e($user->id); ?>,'<?php echo e(addslashes($user->name)); ?>','<?php echo e(addslashes($user->username)); ?>','<?php echo e(addslashes($user->email)); ?>','<?php echo e($user->role); ?>')">
                                    <i class="fas fa-pen"></i>
                                </button>
                                <form method="POST" action="/user/<?php echo e($user->id); ?>" style="display:inline;" onsubmit="return confirm('Yakin hapus user ini?')">
            ...
            <div class="pagination-container"><?php echo e($users->links('pagination::simple-tailwind')); ?></div>
        </div>
    </div>
...
<?php /**PATH C:\poliklinik_v2\resources\views/user.blade.php ENDPATH**/ ?>