            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($jadwal->nama_dokter); ?></td>
                        <td><?php echo e($jadwal->spesialis); ?></td>
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="btn-action btn-edit"
                                    onclick="bukaModalEdit(<?php echo e($jadwal->id); ?>,'<?php echo e(addslashes($jadwal->nama_dokter)); ?>','<?php echo e(addslashes($jadwal->spesialis)); ?>','<?php echo e($jadwal->hari); ?>','<?php echo e($jadwal->jam_mulai); ?>','<?php echo e($jadwal->jam_selesai); ?>')">
                                    <i class="fas fa-pen"></i>
                                </button>
                                <form method="POST" action="/jadwaldokter/<?php echo e($jadwal->id); ?>" style="display:inline;" onsubmit="return confirm('Yakin hapus jadwal ini?')">
...
<?php /**PATH C:\poliklinik_v2\resources\views/jadwaldokter.blade.php ENDPATH**/ ?>