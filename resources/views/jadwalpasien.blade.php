...
<body>
        ...
        <div class="header-container">
            ...
            <div class="action-bar">
                ...
                <div class="search-box">
                    ...
                    <input type="text" name="search" placeholder="Cari pasien..." value="{{ request('search') }}" onchange="this.form.submit()">
                </div>
                </form>
            </div>
        </div>
    ...
    $filteredAntreens = $search
        ...
        : $antreens;
@endphp
@forelse ($filteredAntreens as $index => $antrean)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            ...
                            <td><span class="status-badge" style="background-color: #e3f2fd; color: #1976d2;">{{ ucfirst($antrean->status) }}</span></td>
                        </tr>
                    @empty
                        <tr>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:15px;margin-bottom:15px;">
                    ...
                    <div>
                        ...
                        <select name="dokter" style="width:100%;padding:9px 12px;border:1px solid #ddd;border-radius:6px;font-size:14px;">
                            ...
                            @foreach(\App\Models\JadwalDokter::orderBy('nama_dokter')->get() as $jd)
                            <option value="{{ $jd->nama_dokter }}">{{ $jd->nama_dokter }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
